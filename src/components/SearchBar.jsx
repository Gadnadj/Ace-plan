    ...
    <div className="px-4 py-3">
      <div className="relative mx-auto max-w-lg">
        ...
        <input
          ...
          className="w-full rounded-2xl border-2 border-slate-200 bg-white py-4 ps-12 pe-4 text-right text-lg font-medium text-slate-800 outline-none focus:border-blue-500"
